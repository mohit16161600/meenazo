...
import genCoupons from "./generated/coupons.json";
...
const fallbackCoupons: Coupon[] = [
  ...
  // value 0 so this ONLY waives shipping (handled in useCartSummary) — no double discount.
  { code: "FREESHIP", type: "flat", value: 0, minOrder: 0, description: "Free shipping on any order", active: true },
];

export const coupons: Coupon[] =
  Array.isArray(genCoupons) && (genCoupons as unknown[]).length
    ? (genCoupons as unknown as Coupon[])
    : fallbackCoupons;
